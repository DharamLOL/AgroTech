...
const PerfilEmpresa = () => {
  ...
  const [imagemPreview, setImagemPreview] = useState("../assets/foto-perfil.jpg");
  ...
  const handleReset = () => {
    ...
    setNumero("");
    setComplemento("");
    setImagemPreview("images/imagem_padrao.png");
  };

  return (
    <div className={Perfil.whiteBorder}>
      <header>
        <button className={Perfil.voltar} onClick={() => window.history.back()}>
          Voltar
        </button>
        <h1>MEU PERFIL</h1>
      </header>
        ...
        <form onSubmit={handleSubmit} onReset={handleReset}>
          ...
          <section className={Perfil.fotoPerfil}>
            <label
              htmlFor="uploadFoto"
              tabIndex="0"
              aria-label="Clique para alterar a foto da empresa"
            >
              <img src={imagemPreview} alt="Foto do perfil da empresa" />
              <input
                type="file"
                id="uploadFoto"
                accept="image/*"
          ...
          <div className={Perfil.formGroup}>
            ...
            <input type="text" id="CNPJ" value="00.000.000/0000-00" readOnly />
          </div>
